...
class ViewReply extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ViewStudentScholarships(title: 'Scholarships'),
    );
  }
}

class ViewStudentScholarships extends StatefulWidget {
  const ViewStudentScholarships({super.key, required this.title});

  final String title;

  @override
  State<ViewStudentScholarships> createState() => _ViewReplyPageState();
}

class _ViewReplyPageState extends State<ViewStudentScholarships> {
  ...
  Future<void> viewreply() async {
    ...
    try {
      ...
      String url = '$urls/student_view_scholarship/';
