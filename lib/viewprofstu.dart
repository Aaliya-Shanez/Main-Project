...
class Studentviewprof extends StatefulWidget {
  const Studentviewprof({super.key, required this.title});


  final String title;

  @override
  State<Studentviewprof> createState() => _StudentviewprofState();
}
class _StudentviewprofState extends State<Studentviewprof> {
  @override
  void initState() {
