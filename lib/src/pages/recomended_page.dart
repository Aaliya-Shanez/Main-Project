...
import 'package:scholarchain/src/theme/theme.dart';
          ...
          Container(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  SizedBox(width: 10),
                  _chip("Data Scientist", Colors.lightBlue, height: 5),
                ],
              )),
          SizedBox(height: 10)
        ],
              ...
              children: <Widget>[
                ...
                Container(
                  child: Row(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Text(model.ScholarshipName!,
                            style: TextStyle(
                ...
                Row(
                  children: <Widget>[
                    _chip(model.StartDate!, LightColor.darkOrange, height: 5),
                    SizedBox(
                      width: 10,
                    ),
