...
class ViewReply extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ViewScholarshipPagess(title: 'Scholarships'),
    );
  }
}

class ViewScholarshipPagess extends StatefulWidget {
  const ViewScholarshipPagess({super.key, required this.title});

  final String title;

  @override
  State<ViewScholarshipPagess> createState() => _ViewReplyPageState();
}

class _ViewReplyPageState extends State<ViewScholarshipPagess> {
